...
{   
    ...
    if($availability!=null){
        for($i=0;$i<15;$i++)
        {    //1.filter the index to the day
             //2.formulating $_POST request name to met the checkbox setting
             //3.Setting Posting value
             if($i=='0'||$i=='1'||$i=='2'){$dayontheweek=1;$name="Monday[]";}//monday
             else if($i=='3'||$i=='4'||$i=='5'){$dayontheweek=2;$name='Tuesday[]';}//tuesday
             else if($i=='6'||$i=='7'||$i=='8'){$dayontheweek=3;$name='Wednesday[]';}//wednsday
             else if($i=='9'||$i=='10'||$i=='11'){$dayontheweek=4;$name='Thursday[]';}//thursday
             else if($i=='12'||$i=='13'||$i=='14'){$dayontheweek=5;$name='Friday[]';}//friday                              
             ...
             {
                $value="Morning";
                if($shifttype=="Morning"||$shifttype=="Morning_Afternoon"||$shifttype=="Morning_Evening"||$shifttype=="FullDay"){$checked='checked';}
             }
             elseif($i=='1'||$i=='4'||$i=='7'||$i=='10'||$i=='13')
             {
                $value="Afternoon";
                if($shifttype=="Afternoon"||$shifttype=="Morning_Afternoon"||$shifttype=="Afternoon_Evening"||$shifttype=="FullDay"){$checked='checked';}
             }
             elseif($i=='2'||$i=='5'||$i=='8'||$i=='11'||$i=='14')
             {
                $value="Evening";
                if($shifttype=="Evening"||$shifttype=="Morning_Evening"||$shifttype=="Afternoon_Evening"||$shifttype=="FullDay"){$checked='checked';}            
             }  
            echo 
        ...
        for($i=0;$i<15;$i++)
        {
            ...
            //formulating shifttype to met the checkbox setting
            $checked="";
            if($i=='0'||$i=='3'||$i=='6'||$i=='9'||$i=='12'){$value="Morning";}
            elseif($i=='1'||$i=='4'||$i=='7'||$i=='10'||$i=='13'){$value="Afternoon";}
            elseif($i=='2'||$i=='5'||$i=='8'||$i=='11'||$i=='14'){$value="Evening";}  
            echo 
            '<div class="CheckBox_Container">
            <label class="customer_checkbox_container">
            <input class="default_checkbox" type="checkbox" name="'.$name.'" value="'.$value.'"'.$checked.'>
