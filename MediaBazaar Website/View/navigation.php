...
<a href="?page=pageLogin"><?php $session=SessionController:: getInstance();
    if(!$session-> __isset('BSN')){echo 'Login';} ?></a>
<a href="?page=pageProfile"><?php $session=SessionController:: getInstance();

    if($session-> __isset('BSN')){echo 'Profile';} ?></a>
<a href="?page=pageAssignedShift"><?php $session=SessionController:: getInstance();
    if($session-> __isset('BSN')){echo 'Assigned shifts';} ?></a>
<a href="?page=pageAvailability"><?php $session=SessionController:: getInstance();
    if($session-> __isset('BSN')){echo 'Availability shifts';} ?></a>    
<form method="post" action="">
    <?php $session=SessionController:: getInstance();
