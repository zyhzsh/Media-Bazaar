        ...
        private void lvrequests_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            if (indices.Count >0)
            {
                ...
                if (selectedEmployee != null)
                {
                    ...
                    if (string.Compare(newEmployee.contactEmail ,selectedEmployee.contactEmail, (StringComparison)CompareOptions.IgnoreSymbols)==null) { lblEmail.ForeColor = Color.Red; }
